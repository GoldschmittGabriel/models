...
class ObjectDetectionEvaluator(DetectionEvaluator):
  ...
  def get_estimator_eval_metric_ops(self, eval_dict):
    ...
    def first_value_func():
      ...
      self.clear()
      logging.error(self._metrics[self._metric_names[0:3]])
      return np.float32(self._metrics[self._metric_names[0:3]])
    ...
    eval_metric_ops = {self._metric_names[0:3]: (first_value_op, update_op)}
    with tf.control_dependencies([first_value_op]):
      for metric_name in self._metric_names[4:]:
...
class OpenImagesDetectionEvaluator_Customized_Top3(ObjectDetectionEvaluator):
  ...
  def __init__(self,
               ...
               evaluate_masks=False,
               evaluate_corlocs=False,
               metric_prefix='CustomTop3OpenImagesV2',
               group_of_weight=0.0):
    """Constructor.
    ...
    super(OpenImagesDetectionEvaluator_Customized_Top3, self).__init__(
        categories,
...
class Custom_OpenImagesChallengeEvaluator_Top3(OpenImagesDetectionEvaluator_Customized_Top3):
  ...
  def __init__(self,
    ...
    super(Custom_OpenImagesChallengeEvaluator_Top3, self).__init__(
        categories,
        matching_iou_threshold,
        evaluate_masks=evaluate_masks,
  ...
  def add_single_ground_truth_image_info(self, image_id, groundtruth_dict):
    ...
    Raises:
      ValueError: On adding groundtruth for an image more than once.
    """
    super(Custom_OpenImagesChallengeEvaluator_Top3,
  ...
  def clear(self):
    ...
    super(Custom_OpenImagesChallengeEvaluator_Top3, self).clear()
...
class Custom_OpenImagesDetectionChallengeEvaluator_Top3(Custom_OpenImagesChallengeEvaluator_Top3):
  ...
  def __init__(self,
    ...
    Args:
      ...
      evaluate_corlocs: if True, additionally evaluates and returns CorLoc.
    """
    super(Custom_OpenImagesDetectionChallengeEvaluator_Top3, self).__init__(
...
class Custom_OpenImagesInstanceSegmentationChallengeEvaluator_Top3(
    Custom_OpenImagesDetectionChallengeEvaluator_Top3):
  ...
  def __init__(self,
    ...
    Args:
      ...
      evaluate_corlocs: if True, additionally evaluates and returns CorLoc.
    """
    super(Custom_OpenImagesInstanceSegmentationChallengeEvaluator_Top3, self).__init__(
        categories=categories,
        evaluate_masks=True,
        matching_iou_threshold=matching_iou_threshold,
        evaluate_corlocs=False,
