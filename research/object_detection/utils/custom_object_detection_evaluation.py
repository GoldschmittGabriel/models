...
class OpenImagesDetectionEvaluator_Customized(ObjectDetectionEvaluator):
  ...
  def __init__(self,
               ...
               evaluate_masks=False,
               evaluate_corlocs=False,
               metric_prefix='CustomOpenImagesV2',
               group_of_weight=0.0):
    """Constructor.
    ...
    super(OpenImagesDetectionEvaluator_Customized, self).__init__(
        categories,
...
class Custom_OpenImagesChallengeEvaluator(OpenImagesDetectionEvaluator_Customized):
...
class Custom_OpenImagesDetectionChallengeEvaluator(Custom_OpenImagesChallengeEvaluator):
...
class Custom_OpenImagesInstanceSegmentationChallengeEvaluator(
    Custom_OpenImagesDetectionChallengeEvaluator):
  ...
  def __init__(self,
    ...
    Args:
      ...
      evaluate_corlocs: if True, additionally evaluates and returns CorLoc.
    """
    super(Custom_OpenImagesInstanceSegmentationChallengeEvaluator, self).__init__(
        categories=categories,
        evaluate_masks=True,
        matching_iou_threshold=matching_iou_threshold,
        evaluate_corlocs=False,
